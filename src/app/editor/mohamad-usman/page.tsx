...
export default function page() {
  return (
    <div>
      <div className='mx-auto mt-6 max-w-screen-lg md:flex'>
        <div className='relative p-2 md:w-1/3'>
          <div className='md:fixed'>
            <div className='md:block'>
              <Image
                ...
                height={128}
              />
              <div className='mb-12 mt-4 items-center justify-center text-center'>
                ...
                <div className='mt-1 text-gray-600 md:hidden'>
                  (
                  <a
                    href='/cdn-cgi/l/email-protection'
                    className='__cf_email__'
                    data-cfemail='79141611570c0a141817484f41391e14181015571a1614'
                  >
                    [email&#160;protected]
                  </a>
                  )
            ...
            <div className='mx-4 my-4 hidden md:block'>
              <div className='my-5 flex text-lg text-gray-600'>
                <div className='mr-2'>
                  <svg
                ...
                <a href='https://veilmail.io/e/hpz_Hv'>
                  https://veilmail.io/e/hpz_Hv
                </a>
              </div>
              <div className='my-5 flex text-lg text-gray-600'>
                <div className='mr-2'>
              ...
              <a
                ...
                className='my-5 flex text-lg text-blue-500'
              >
                <div className='mr-2'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
            ...
            <div className='mx-4 hidden md:block'>
              <a
                href='https://veilmail.io/e/hpz_Hv'
                className='focus:shadow-outline-blue inline-flex w-full items-center justify-center rounded bg-blue-600 py-2 text-base text-white transition duration-150 ease-in-out hover:bg-blue-500 focus:border-blue-700 focus:outline-none active:bg-blue-700'
              >
                Hire me
              </a>
            </div>
        ...
        <div className='w-full p-2 md:w-2/3'>
          <div className='mx-4 mb-6'>
            <h1 className='mb-4 text-4xl font-bold text-gray-700'>Summary</h1>
            <p className='text-lg'>
            ...
            <ul>
              ...
              <li className='mb-4'>
                ...
                <div className='mt-1'>
                  <div>
                    <i className='bx bx-buildings'></i>
                    <small className='text-base text-gray-800'>Freelance</small>
                  </div>
                  <div>
                    <i className='bx bx-calendar text-sm'></i>
                    <small className='text-sm text-gray-600'>
          ...
          <div className='mx-4'>
            <h1 className='mb-4 text-4xl font-bold text-gray-700'>Skill</h1>
            <ul>
              <li className='mb-6 flex flex-wrap'>
                <span className='my-1 mr-2 rounded-full border bg-gray-200 px-4 py-2 text-sm font-medium'>
                  Flask
                </span>
                <span className='my-1 mr-2 rounded-full border bg-gray-200 px-4 py-2 text-sm font-medium'>
                  Python Pandas
