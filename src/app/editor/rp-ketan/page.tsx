...
export default function RpKetanCv() {
  return (
    <div>
            ...
            <div className='col-span-4 sm:col-span-3'>
              <div className='rounded-lg bg-white p-6 shadow'>
                ...
                <div className='flex flex-col'>
                  <span className='mb-2 font-bold uppercase tracking-wider text-gray-600'>
                    Skills
                  </span>
                  <ul>
              ...
              <div className='rounded-lg bg-white p-6 shadow'>
                ...
                <div className='mb-6'>
                  <div className='flex justify-between'>
                    ...
                    <p>
                      <span className='mr-2 text-gray-600'>at ABC Company</span>
